 ...
 */
const AnimatedRotateSwitchComponent = (props) => {
  const {
    toggle,
    firstComponent,
    secondComponent,
  ...
  return (
    ...
    >
      ...
      <Animated.View
        style={[{ position: base? undefined : "absolute", pointerEvents: toggle ? "auto" : "none" }, styleSwitchSecond]}
      >
        {secondComponent}
      </Animated.View>
    </View>
...
AnimatedRotateSwitchComponent.propTypes = {
...
export default AnimatedRotateSwitchComponent;
